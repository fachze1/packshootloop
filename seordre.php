...
<head>
  ...
  <meta name="author" content="Lasse, Morten, Anne Mette, Lasse og Mostafa">
  <title>Packshoot - Specifik ordre</title>
...
<body>
  ...
  $rowcompany = mysqli_fetch_array($result, MYSQLI_ASSOC);
  ?>

    <!-- Sidebar -->
    <div class="bg-dark text-white border-right" id="sidebar-wrapper">
      <div class="sidebar-heading text-center"><?php echo $rowcompany['company']; ?></div>
      <div class="list-group list-group-flush">
        <a href="mineordrer.php" class="list-group-item list-group-item-action bg-dark text-white"><i
            class="fas fa-list-alt mx-2"></i>Mine ordrer</a>
      </div>
    ...
    <div id="page-content-wrapper">
      ...
      <?php
require_once('pages/tabelspecifikordre.php');
?>
    </div>
    <script src='js/mainny.js'></script>
